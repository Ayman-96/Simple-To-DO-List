let myArray =  JSON.parse(localStorage.getItem('storage')) || [{       //an array of objects
  name : 'What to do ?', 
  dueDate : '1-1-2025'
},{
  name : 'Add a Task',
...
function renderTodoList(){ // to display the inputs
  let empty = '';
  ...
  .forEach((deleteButton,index) => {     // (   ()=>{ }  ) delete button is just name for elements (listenerAll gives index to buttons)
...
function addTodo(){ // adding new element to array
